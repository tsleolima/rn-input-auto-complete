...
class AutoComplete extends Component {
  ...
  isSimilar = (value, suggestionText) => {
    ...
    const newValue = value.toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g, "");
    const newSuggestionText = suggestionText.toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g, "");
    const suggestionScore = stringScore(
      newSuggestionText, newValue, this.props.comparationFuzziness
    )
